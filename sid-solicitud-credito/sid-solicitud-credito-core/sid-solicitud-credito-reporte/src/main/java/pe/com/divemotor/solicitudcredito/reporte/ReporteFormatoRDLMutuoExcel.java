 ...
 * @author legutierrez
 */
public class ReporteFormatoRDLMutuoExcel {

    public ReporteFormatoRDLMutuoExcel() {
        super();
    }
    ...
    public byte[] generarReporte(ReporteFormatoRDLMutuoDataSource dataSource) throws Exception {
        ...
        InputStream isReportePrincipal = classLoader.getResourceAsStream("/reporte/excel/formatoRDLMutuo.jasper");
