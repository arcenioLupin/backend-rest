 ...
 * @author jaltamirano
 */
public class ReporteCreditoOtorgadoExcel {

    public byte[] generarReporte(ReporteCreditoOtorgadoExcelDataSource dataSource, ReporteCreditoOtorgado reporteCO) throws Exception {
        ClassLoader classLoader = this.getClass().getClassLoader();
        InputStream isReportePrincipal = classLoader.getResourceAsStream("/reporte/excel/reporteCreditoOtorgado.jasper");
        InputStream pathLogo = classLoader.getResourceAsStream("/reporte/imagen/logo_divemotor.jpg");

        ObjectMapper objectMapper = new ObjectMapper();
        Map<String, Object> parameters = objectMapper.convertValue(reporteCO, Map.class);
