 ...
 * @author jaltamirano
 */
public class ReporteVistaOperacionExcelDataSource {
    ...
    private String nroLetrasVencidass;
    ...
    public String getNroLetrasVencidass() {
        return nroLetrasVencidass;
    }

    public void setNroLetrasVencidass(String nroLetrasVencidass) {
        this.nroLetrasVencidass = nroLetrasVencidass;
    }
