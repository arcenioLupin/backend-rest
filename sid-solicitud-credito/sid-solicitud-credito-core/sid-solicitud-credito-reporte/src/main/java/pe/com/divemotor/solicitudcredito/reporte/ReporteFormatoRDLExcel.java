 ...
 * @author legutierrez
 */
public class ReporteFormatoRDLExcel {

    public ReporteFormatoRDLExcel() {
        super();
    }
    
    public byte[] generarReporte(ReporteFormatoRDLExcelDataSource dataSource) throws Exception {

        ClassLoader classLoader = this.getClass().getClassLoader();
        InputStream isReportePrincipal = classLoader.getResourceAsStream("/reporte/excel/formatoRDL.jasper");
