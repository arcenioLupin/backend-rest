 ...
 * @author legutierrez
 */
public class ReporteResumenEjecutivoPdf {
    
    public ReporteResumenEjecutivoPdf() {
        super();
    }

    public byte[] generarReporte(ReporteResumenEjecutivoPdfDataSource dataSource) throws Exception {

        ClassLoader classLoader = this.getClass().getClassLoader();
        InputStream isReportePrincipal = classLoader.getResourceAsStream("/reporte/pdf/reporteResumenEjecutivo.jasper");
