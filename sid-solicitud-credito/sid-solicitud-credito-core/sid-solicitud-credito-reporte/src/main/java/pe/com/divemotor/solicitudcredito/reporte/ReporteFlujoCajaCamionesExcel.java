 ...
 * @author mbardales
 */
public class ReporteFlujoCajaCamionesExcel {

    public ReporteFlujoCajaCamionesExcel() {
        super();
    }
   
    public byte[] generarReporte(ReporteFlujoCajaExcelDataSource dataSource) throws Exception {

        ClassLoader classLoader = this.getClass().getClassLoader();
        InputStream isReportePrincipal = classLoader.getResourceAsStream("/reporte/excel/reporteFlujoCajaCamiones.jasper");
