 ...
 * @author USER
 */
public class ReportePolizasExcel {

    public ReportePolizasExcel() {
        super();
    }

    public byte[] generarReporte(ReportePolizasExcelDataSource dataSource) throws Exception {

        ClassLoader classLoader = this.getClass().getClassLoader();
        InputStream isReportePrincipal = classLoader.getResourceAsStream("/reporte/excel/reporteConsultaPolizas.jasper");
