...
public interface SolicitudCreditoDAO {
    ...
    void listarSoliSuscripNotaria(ListarSolicitudCreditoSNProcedure procedureParams);

    void actualizar(ActualizarSolicitudCreditoProcedure parametros);

    void actualiarGestionBancaria(ActualizarGestionBancaria parametros);

    void actualizarCartaBanco(ActualizarSolicitudCreditoCBProcedure parametros);

    void actualizarSoliSuscripNotaria(ActualizarSolicitudCreditoSNProcedure procedureParams);
    ...
    void listarParametrosRegistroSolcre(ListarParamRegSolcreProcedure parametros);//I Req. 87567 E2.1 ID:9 AVILCA 12/05/2020
    
    void listarClienteCreditos(ListarClienteCreditoProcedure parametros);//I Req. 87567 E2.1 ID:9 AVILCA 10/02/2021
    
    void listarClienteMovimientos(ListarClienteMovimientoProcedure parametros);//I Req. 87567 E2.1 ID:9 AVILCA 10/02/2021
}
