...
public class ResumenFinanciero {
    private String codmaeeeff;
    private String codcliente;
    private String valanoeeff;
    ...
    private double valbgpcbancdeudfinacp;
    ...
    public String getCodmaeeeff() {
        return codmaeeeff;
    }

    public void setCodmaeeeff(String codmaeeeff) {
        this.codmaeeeff = codmaeeeff;
    }
    ...
    public String getValanoeeff() {
        return valanoeeff;
    }

    public void setValanoeeff(String valanoeeff) {
