...
public class SolicitudCreditoProforma {
    ...
    private String valVtaProf;
    private String codSoliCred;

    public String getEstadoFichaVenta() {
        return estadoFichaVenta;
    }

    public void setEstadoFichaVenta(String estadoFichaVenta) {
        this.estadoFichaVenta = estadoFichaVenta;
    }
    ...
    public String getValVtaProf() {
        return valVtaProf;
    }

    public void setValVtaProf(String valVtaProf) {
