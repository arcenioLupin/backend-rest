...
public class InsertarGarantiaProcedure extends BaseProcedure {
    ...
    private Double valConstGar;
    private Double valRealizGar;
    private Double codOfRegistral;
    ...
    private Double valNvoMonto;
    private Double valNvoVal;
    private Double valMontOtorHip;
    ...
    private String listaGarantias;
    private String listaGarantiasEliminadas;
    ...
    public String getIndOtor() {
        return indOtor;
    }

    public void setIndOtor(String indOtor) {
        this.indOtor = indOtor;
    }
    ...
    public Double getCodOfRegistral() {
        return codOfRegistral;
    }

    public void setCodOfRegistral(Double codOfRegistral) {
    ...
    public String getListaGarantias() {
        return listaGarantias;
    }

    public void setListaGarantias(String listaGarantias) {
    ...
    public Double getValConstGar() {
        return valConstGar;
    }

    public void setValConstGar(Double valConstGar) {
        this.valConstGar = valConstGar;
    }

    public Double getValRealizGar() {
        return valRealizGar;
    }

    public void setValRealizGar(Double valRealizGar) {
        this.valRealizGar = valRealizGar;
    }

    public Double getValNvoMonto() {
        return valNvoMonto;
    }

    public void setValNvoMonto(Double valNvoMonto) {
        this.valNvoMonto = valNvoMonto;
    }

    public Double getValNvoVal() {
        return valNvoVal;
    }

    public void setValNvoVal(Double valNvoVal) {
        this.valNvoVal = valNvoVal;
    }

    public Double getValMontOtorHip() {
        return valMontOtorHip;
    }

    public void setValMontOtorHip(Double valMontOtorHip) {
    ...
    public String getListaGarantiasEliminadas() {
        return listaGarantiasEliminadas;
    }

    public void setListaGarantiasEliminadas(String listaGarantiasEliminadas) {
        this.listaGarantiasEliminadas = listaGarantiasEliminadas;
    }
