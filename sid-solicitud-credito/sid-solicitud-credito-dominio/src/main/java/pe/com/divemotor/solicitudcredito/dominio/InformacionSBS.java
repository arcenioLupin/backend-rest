...
public class InformacionSBS {
    ...
    private double valDeudActuClie;
    private double valDeudActuRepr;
    private double valDeudCierAnoActuClie;
    private double valDeudCierAnoActuRepr;
    private double valDeudCierAnoAnteClie;
    ...
    public double getValDeudActuClie() {
        return valDeudActuClie;
    }

    public void setValDeudActuClie(double valDeudActuClie) {
    ...
    public double getValDeudCierAnoActuClie() {
        return valDeudCierAnoActuClie;
    }

    public void setValDeudCierAnoActuClie(double valDeudCierAnoActuClie) {
    ...
    public double getValDeudCierAnoAnteClie() {
        return valDeudCierAnoAnteClie;
    }

    public void setValDeudCierAnoAnteClie(double valDeudCierAnoAnteClie) {
